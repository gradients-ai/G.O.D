...
RUN chmod +x /workspace/ops/trainer_ops/run_text_trainer.sh /workspace/trainer/entrypoints/text_trainer.py

ENTRYPOINT ["/workspace/ops/trainer_ops/run_text_trainer.sh"]
