...
# Fixed root of the text previous-winner lineage: the boss scenario continues the previous text
# champion's repo when its persisted base matches this, else restarts from it.
TEXT_PREV_WINNER_ROOT_MODEL = "Qwen/Qwen2.5-7B"
