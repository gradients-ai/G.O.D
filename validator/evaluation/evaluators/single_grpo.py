...
from validator.evaluation.evaluators.grpo import evaluate_grpo_repo
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        ...
        logger.error(
            "Usage: python -m validator.evaluation.evaluators.single_grpo <serialized_evaluation_args>"
        )
        sys.exit(1)
