...
from validator.evaluation.evaluators.grpo import _adapt_grpo_columns_to_trl
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        ...
        logger.error(
            "Usage: python -m validator.evaluation.evaluators.single_kl_divergence <serialized_evaluation_args>"
        )
        sys.exit(1)
