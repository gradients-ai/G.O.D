...
Examples:
    python -m scripts.test_model_prep_envs --model Qwen/Qwen2.5-0.5B-Instruct
    python -m scripts.test_model_prep_envs --model Qwen/Qwen2.5-0.5B-Instruct --episodes 2 --gpu-ids 0,1
"""
