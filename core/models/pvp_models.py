...
class TwentyFortyEightParams(GameParams):
    game: Literal["2048"] = "2048"
    max_tile: int = 2048


AnyGameParams = Annotated[
    LiarsDiceParams | LeducPokerParams | GinRummyParams | OthelloParams | GoofspielParams | TwentyFortyEightParams,
